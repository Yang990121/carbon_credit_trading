                                ...
                                <TableRow key={index}>
                                    {tableHeaders.map(
                                        (header, headerIndex) => (
                                            ...
                                            >
                                                {project[header]}
                                                {role === "certifier" && header === "verificationStatus" ?
                                                    <>
                                                        <PopupButton projectId={project[0]} selectedAccount={selectedAccount} />
                                                    </>
                                    ...
                                    {role === "company" ? <CreditPurchase account={selectedAccount} project={project} projects={projects} /> : <></>}
                                </TableRow>
                            ))
                            : null}
                    </TableBody>
